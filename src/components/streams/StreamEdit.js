...
class StreamEdit extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <h3>Edit a Stream</h3>
        {/* //initialValues={this.props.stream} verirsek id dahil tüm değerleri alır bunu istemeyiz */}
        {/* _.pick lodashdan gelir ve içerisine veridğimiz değerleri gösterir sadece diğğerlerini göstermez */}
